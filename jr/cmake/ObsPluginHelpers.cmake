# this is from exeldro; the older ObsHelpers.cmake from obs is breaking with v30.x
...
#  	setup_target_resources("${target}" "obs-plugins/${target}")
    ...
    add_custom_command(
      ...
      COMMENT "Installing to obs plugin rundir"
      VERBATIM)
  endfunction()

  # Helper function to add resources from "data" directory
  function(setup_target_resources_EXELDRO target destination)
    if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/data)
      install(
