...
function updateStatus(vals) {
	...
	if (eldiv && vals.hasOwnProperty("connectionStatus")) {
		eldiv.innerHTML = vals.connectionStatus ? vals.connectionStatus : "not connected";
	}
	...
	if (eldiv && vals.hasOwnProperty("lastError")) {
		eldiv.innerHTML = vals.lastError ? vals.lastError : "none";
	}
	...
	if (eldiv && vals.hasOwnProperty("wsAddress")) {
		eldiv.value = vals.wsAddress;
	}
	eldiv = document.getElementById("wsPassword");
	if (eldiv && vals.hasOwnProperty("wsPassword")) {
